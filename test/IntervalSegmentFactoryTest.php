...
class IntervalSegmentFactoryTest extends TestCase
{
    ...
    private const DATETIME_MATCHING_SEGMENT = 'datetime_matching_segment';
    ...
    public function testItShouldKnownAvailableSegmentTypes(): void
    {
        ...
        $this->assertSame([
            self::DATETIME_MATCHING_SEGMENT,
    ...
    public function testItShouldCreateInstancesOfDateTimeIntervalMatchingSegment(): void
    {
        $factory = new IntervalSegmentFactory(SystemClock::create());

        $segment = $factory->create(self::SEGMENT_ID, self::DATETIME_MATCHING_SEGMENT, self::DATETIME_CRITERIA);
        $this->assertInstanceOf(IntervalMatchingSegment::class, $segment);
    }
}
